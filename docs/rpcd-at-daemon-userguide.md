...
### 1. Sharing Serial Port with XModem
If you want to share the serial port with XModem, you need to enable ubus at mode in XModem configuration. Otherwise, ubus at will monopolize the serial port buffer after startup, preventing XModem from receiving information.

**Configuration method:**
```bash
uci set xmodem.1_1_2.use_ubus='1'
uci commit xmodem
```
