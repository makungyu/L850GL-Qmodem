# lpac for XModem — eSIM/eUICC Support
...
When used with XModem, lpac shares `/dev/cdc-wdm0` with quectel-CM via `mbim-proxy`:
...
uci set xmodem.<section>.use_mbim_proxy='1'
uci commit xmodem
/etc/init.d/xmodem_network reload
```
