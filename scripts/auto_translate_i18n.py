...
def main():
    ...
    parser.add_argument(
        '--sh-path',
        default='application/xmodem/files/usr/share/xmodem',
    ...
    parser.add_argument(
        '--example-po',
        default='luci/luci-app-xmodem/po/zh_Hans/xmodem.po',
        help='Path to example PO file for translation reference'
    )
    
    parser.add_argument(
        '--output',
        default='luci/luci-app-xmodem-next/po/zh_Hans/xmodem-next.po',
