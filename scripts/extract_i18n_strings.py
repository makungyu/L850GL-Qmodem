...
def generate_po_template(items: List[Dict[str, any]], output_file: str = None):
    ...
    """
    lines = []
    lines.append('# Translation template for luci-app-xmodem-next')
...
Examples:
  ...
  %(prog)s --js-path luci/luci-app-xmodem-next/htdocs/luci-static/resources --sh-path application/xmodem/files/usr/share/xmodem
        """
    )
    ...
    parser.add_argument(
        '--js-path',
        default='luci/luci-app-xmodem-next/htdocs/luci-static/resources',
