...
'require ui';
'require poll';
'require xmodem.modem_cfg as modemCfg';
...
return view.extend({
	...
	render: function(data) {
		...
		m = new form.Map('xmodem', _('XModem Settings'));
				...
				E('div', { 'class': 'right' }, [
					...
					E('button', {
						...
						'click': L.bind(function() {
							...
							var sid = uci.add('xmodem', 'modem-device', selectedKey);
							
							// Set type and path automatically
							uci.set('xmodem', sid, 'data_interface', deviceInfo.type);
							uci.set('xmodem', sid, 'path', deviceInfo.path);
		...
		o.cfgvalue = function(section_id) {
			var type = uci.get('xmodem', section_id, 'data_interface') || '-';
	...
	s.sortable = true;
	s.modaltitle = L.bind(function(section_id) {
		var slotId = uci.get('xmodem', section_id, 'slot');
