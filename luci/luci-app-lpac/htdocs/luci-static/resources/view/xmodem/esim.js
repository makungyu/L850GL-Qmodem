 ...
 * with the Lua controller at admin/modem/xmodem/esim/*.
 */
...
function loadEsimModules() {
	...
	// In xmodem-next, L.env.requestpath = '/cgi-bin/luci/admin/modem/xmodem/esim'
	// API endpoints are at: admin/modem/xmodem/esim/{chip,profiles,...}
